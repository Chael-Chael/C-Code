...
int main(void)
{
    ...
    // the linked list is {10, 20, 30};
    displayLinkedList( listHead );

    printf("insert multiple nodes (5) in the start of linked list:\n");
    listHead = insertNodeByValue( listHead, 5 );
    listHead = insertNodeByValue( listHead, 5 );
    // the linked list is {5, 5, 10, 20, 30};
    displayLinkedList( listHead );
    
    printf("delete multiple nodes (5) in the start of linked list:\n");
    listHead = deleteMultiNodeByValue( listHead, 5 );
    displayLinkedList( listHead );

    printf("insert multiple nodes (20) in the middle of linked list:\n");
    listHead = insertNodeByValue( listHead, 20 );
    // the linked list is {10, 20, 20, 30};
    displayLinkedList( listHead );
    
    printf("delete multiple nodes (20) in the middle of linked list:\n");
    listHead = deleteMultiNodeByValue( listHead, 20 );
    displayLinkedList( listHead );
